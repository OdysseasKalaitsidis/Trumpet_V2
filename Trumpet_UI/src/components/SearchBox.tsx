...
export default function SearchBox() {
  ...
  return (
    <div
      className={`flex items-center transition-all duration-500 ease-liquid ${
        isOpen ? "w-full md:w-96" : "w-10"
      }`}
    >
      {isOpen ? (
        <form
          className="flex-1 flex items-center bg-white/10 backdrop-blur-md border border-white/20 rounded-full pl-2 pr-4 py-1"
